...
public class HelloworldServletContextListener implements ServletContextListener {
    ...
    public void contextDestroyed(ServletContextEvent event) {
    	System.out.println("HelloworldServletContextListener.contextDestroyed() :"+event.getServletContext());
    }
    ...
    private String prepareMessage(String name) {
        ...
        sb.append("<h2>Packt Helloworld ServletContextListener</h2>");
        sb.append("HelloworldServletContextListener says, "+message);
        sb.append("<hr>");
